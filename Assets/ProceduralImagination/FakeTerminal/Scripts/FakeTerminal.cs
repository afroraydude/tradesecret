...
public class FakeTerminal : MonoBehaviour
{
    ...
    public string[] text_AccessNegate;
    ...
    void LateUpdate()
    {
        ...
        if(lockCamera)
        {
            ...
            /*player_Camera.transform.position = terminalPoV.position;
            player_Camera.transform.rotation = terminalPoV.rotation;*/
    ...
    {
        foreach(string line in text_AccessNegate)
        {
            AddLineToList(line);
        }
    }
